...
app = FastAPI(title='Backstract Generated APIs - accounts-coll-0b53895248604867baf743ac0ff350dc',debug=False,docs_url='/recursing-parvati-a51512a2d7cc11efabf70242ac12000588/docs',openapi_url='/recursing-parvati-a51512a2d7cc11efabf70242ac12000588/openapi.json')

app.include_router(router, prefix='/recursing-parvati-a51512a2d7cc11efabf70242ac12000588/api', tags=['APIs v1'])
